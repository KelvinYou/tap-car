    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(title),
            isTrue ? Icon(Icons.keyboard_arrow_up) : Icon(Icons.keyboard_arrow_down),
          ],
        ),
      ),
    );
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    contentText("To change your address through the App, follow these steps:"),
                    contentText("1. Account > View and edit profile"),
                    contentText("2. Click on ‘Edit’ address"),
                    contentText("3. Input new address"),

                    const SizedBox(height: 20,),
                    titleText("How do I change my password?"),
                    contentText("To change your password through the App, follow these steps:"),
                    contentText("1. Account > View and edit profile"),
                    contentText("2. Click on ‘Edit’ password"),
                    contentText("3. Input current password, new password and retype password to confirm."),
                    contentText("4. Reset password"),

                    const SizedBox(height: 20,),
                    titleText("How do I pay for TapCar’s services?"),
                    contentText("You can pay for TapCar’s services by cash only."),
                    const SizedBox(height: 30,),
                  ],
                ) : const SizedBox(),
                ...
                Divider(),
                rateUsDropDown ? RatingBar.builder(
                  initialRating: rtg,
